  ...
  return (
    <div className='box-border relative slide-represent'>
      <Swiper
        ...
        // }}
        navigation={{
          nextEl: '.slide-representative-next',
          prevEl: '.slide-representative-prev',
        }}
      ...
      <div className='md:flex hidden absolute top-[50%] -translate-y-2/4 z-10 w-full justify-between'>
        <button
          ...
          className='slide-representative-prev w-[3.625vw] h-[3.625vw] rounded-full flex justify-center items-center bg-primaryColor button-slide__tour absolute left-[6.5vw] top-[50%] -translate-y-2/4'
        >
          <svg
            width='24'
            height='24'
        ...
        <button
          ...
          className='slide-representative-next w-[3.625vw] h-[3.625vw] rounded-full flex justify-center items-center bg-primaryColor button-slide__tour absolute right-[6.5vw] top-[50%] -translate-y-2/4'
        >
          <svg
            width='24'
            height='24'
